...
public class HouseController {
    ...
    public ResponseEntity<List<HouseDealDto>> searchByDealDate(@RequestParam Integer dealYear,
                                                               @RequestParam Integer dealMonth) {
